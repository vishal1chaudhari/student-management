...
<!--Cards Creation-->
   ...
   <h1>Teacher Section</h1>
    <ul>
        <li><a href="AdminTeacherDelete.jsp">Delete</a></li>
        <li><a href="AdminTeacherUpdate.jsp">Update</a></li>
        <li><a href="AdminTeacherSearch.jsp">Search</a></li>
        <li><a href="AdminStudentDelete.jsp">Delete</a></li>
        <button class="dropbtn">Display</button>
        <div class="dropdown-content">
        <a href="TeacherDisplayAllController">DisplayAll</a>
        <a href="#">Display-depart</a>
        </div>
